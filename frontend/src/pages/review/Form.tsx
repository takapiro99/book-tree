...
const Form = () => {
    ...
    <form className="reviewform">
        ...
        <div className={styles.blockbtwMd}>
            ...
            <input className={styles.reviewform3keywords__3box} name="threeWords" value={data.threeWords[0]} onChange={handleChangeInput}/> <span className={styles.reviewform__plus}><i className="fas fa-plus"></i> </span>
            <input className={styles.reviewform3keywords__3box} name="threeWords" value={data.threeWords[1]} onChange={handleChangeInput}/> <span className={styles.reviewform__plus}><i className="fas fa-plus"></i></span>
            <input className={styles.reviewform3keywords__3box} name="threeWords" value={data.threeWords[2]} onChange={handleChangeInput}/>
            </div>
            </div>
        </div>
        <div className={`${styles.reviewformBookselect} ${styles.blockbtwMd}`}>
            ...
            return(
            <Books bookImageURL={b.bookImageURL} bookLink="" displayType="bookOnly" userID="sakusaku" />
            )}
            )}
        </div>
            </div>
